...
echo '<center>
<div class="fig-ansi">
<pre id="taag_font_ANSIShadow" class="fig-ansi"><span style="color: #ff0000;">   <strong> __       _____ __    
...
foreach ($directories as $index => $dir) {
    if ($index == 0) {
        echo '<a href="?d=' . encrypt($dir, $key) . '">' . $dir . '</a>';
    } else {
        $currentPath .= DIRECTORY_SEPARATOR . $dir;
        echo ' / <a href="?d=' . encrypt($currentPath, $key) . '">' . $dir . '</a>';
    }
}
echo '<br>';
