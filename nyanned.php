...
// Fungsi untuk menentukan izin file
function perms($file) {
...
<head>
    ...
    <style type="text/css">
        ...
        tr.first{border-bottom:1px dashed #ef6c00;}
        tr:hover{background: #7f2e00;}
        th{background: #ef6c00;padding:5px;}
    </style>
</head>
<body>
<?php
echo '<div style="color:#ef6c00;margin-top:0;"><h1><center>' . $title . '</center></h1></div>';
...
<input type="submit" value="Upload" /></form></td></tr><tr><td></table>';
...
foreach ($scandir as $dir) {
    ...
    echo "</center></td><td><center>".date("d-M-Y H:i", filemtime("$path/$dir"))."</center></td>
...
foreach ($scandir as $file) {
    ...
    echo "</center></td><td><center>".date("d-M-Y H:i", filemtime("$path/$file"))."</center></td>
